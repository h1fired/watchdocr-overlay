...
OCR overlay and translation tool. The application captures a designated screen region, processes text extraction through OCR backend, translates the content, and renders it as an on-screen overlay.
